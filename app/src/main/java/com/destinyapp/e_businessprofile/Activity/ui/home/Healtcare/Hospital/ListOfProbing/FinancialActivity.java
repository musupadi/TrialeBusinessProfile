...
public class FinancialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linear6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (BLinear6 == true){
                    tvLinear6.setVisibility(View.VISIBLE);
                    BLinear6 = false;
                }else if(BLinear6 == false){
                    tvLinear6.setVisibility(View.GONE);
                    BLinear6 = true;
                }
            }
        });
        linear7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (BLinear7 == true){
                    tvLinear7.setVisibility(View.VISIBLE);
                    BLinear7 = false;
                }else if(BLinear7 == false){
                    tvLinear7.setVisibility(View.GONE);
                    BLinear7 = true;
                }
            }
        });
